...
export const getBackground = (name: string | undefined) => {

  switch (name) {
    case "L-1": {
      return <BgLightGradient1 />
    }
    case "L-2": {
      return <BgLightGradient2 />
    }
    case "L-3": {
      return <BgLightGradient3 />
    }
    case "L-4": {
      return <BgLightGradient4 />
    }
    case "L-5": {
      return <BgLightGradient5 />
    }
    case "L-6": {
      return <BgLightGradient6 />
    }
    case "L-7": {
      return <BgLightGridGradient1 />
    }
    case "L-8": {
      return <BgLightGridGradient2 />
    }
    case "L-9": {
      return <BgLightGrid1 />
    }
    ...
    //Dark Cases
    case "D-1": {
      return <BgDarkGradient1 />
    }
    case "D-2": {
      return <BgDarkGradient2 />
    }
    case "D-3": {
      return <BgDarkGradient3 />
    }
    case "D-4": {
      return <BgDarkGradient4 />
    }
    case "D-5": {
      return <BgDarkGradient5 />
    }
    case "D-6": {
      return <BgDarkGridGradient1 />
    }
    case "D-7": {
      return <BgDarkGrid1 />
    }
